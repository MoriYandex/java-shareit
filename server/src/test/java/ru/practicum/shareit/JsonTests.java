...
public class JsonTests {
    ...
    void bookingDtoExtendedTest() throws IOException {
        BookingDtoExtended bookingDtoExtended = new BookingDtoExtended(1L,
                bookingStart,
                bookingEnd,
                new ItemDto(1L, "name1", "description1", true, 1L, null),
                new UserDto(1L, "uname1", "user@user.com"),
    ...
    void itemDtoExtendedTest() throws IOException {
        ItemDtoExtended itemDtoExtended = new ItemDtoExtended(1L,
                "name1",
                "description1",
                true,
                1L,
                null,
                new BookingDto(1L, bookingStart, bookingEnd, 1L, 2L, BookingStatus.APPROVED),
                new BookingDto(1L, bookingStart, bookingEnd, 1L, 2L, BookingStatus.APPROVED),
                List.of(new CommentDto(1L, "text1", 1L, 2L, "name2", bookingEnd)));
    ...
    void requestDtoExtendedTest() throws IOException {
        RequestDtoExtended requestDtoExtended = new RequestDtoExtended(1L,
                "description1",
                1L,
                bookingStart,
                List.of(new ItemDto(1L, "name1", "description1", true, 2L, 1L)));
    ...
    void bookingDtoTest() throws IOException {
        BookingDto bookingDto = new BookingDto(1L, bookingStart, bookingEnd, 1L, 1L, BookingStatus.APPROVED);
    ...
    void itemDtoTest() throws IOException {
        ItemDto itemDto = new ItemDto(1L, "name1", "description1", true, 1L, 1L);
    ...
    void requestDtoTest() throws IOException {
        RequestDto requestDto = new RequestDto(1L, "description1", 1L, bookingStart);
    ...
    void commentDtoTest() throws IOException {
        CommentDto commentDto = new CommentDto(1L, "text1", 1L, 1L, "uname1", bookingStart);
    ...
    void userDtoTest() throws Exception {
        UserDto userDto = new UserDto(1L, "name1", "user1@user.com");
